...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  if (cfgc.options().get<bool>("no-subspec")) {
    ...
    specs.emplace_back(MakeRootTreeWriterSpec(workflowname.data(), "focalevents.root", "o2sim",
                                              ...
                                              MakeRootTreeWriterSpec::BranchDefinition<std::vector<HCALEvent>>{InputSpec{"datahcal", o2::framework::ConcreteDataTypeMatcher{"FOC", "HCALSPCBS"}}, "FOCALHCAL", "hcal-branch-name"},
    ...
    specs.emplace_back(MakeRootTreeWriterSpec(workflowname.data(), "focalevents.root", "o2sim",
                                              ...
                                              MakeRootTreeWriterSpec::BranchDefinition<std::vector<HCAEvent>>{InputSpec{"datahcal", "FOC", "HCALSPCBS", subspec}, "FOCALHCAL", "hcal-branch-name"},
