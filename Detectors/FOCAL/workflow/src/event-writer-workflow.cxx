...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  if (cfgc.options().get<bool>("no-subspec")) {
    ...
    specs.emplace_back(MakeRootTreeWriterSpec(workflowname.data(), "focalevents.root", "o2sim",
                                              ...
                                              MakeRootTreeWriterSpec::BranchDefinition<std::vector<HCALEvent>>{InputSpec{"datahcal", o2::framework::ConcreteDataTypeMatcher{"FOC", "HCALPCBS"}}, "FOCALHCAL", "hcal-branch-name"},
    ...
    specs.emplace_back(MakeRootTreeWriterSpec(workflowname.data(), "focalevents.root", "o2sim",
                                              ...
                                              MakeRootTreeWriterSpec::BranchDefinition<std::vector<HCALEvent>>{InputSpec{"datahcal", "FOC", "HCALPCBS", subspec}, "FOCALHCAL", "hcal-branch-name"},
